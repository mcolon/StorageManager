    ...
    public class StorageQueryBuilder
    {
        ...
        public static TableQuery GetQueryById(string id)
        {
            var query = TableQuery.CombineFilters(
                TableQuery.GenerateFilterCondition("PartitionKey", QueryComparisons.Equal, MAIN_PARTITION_NAME),
                TableOperators.And,
        ...
        public StorageQueryBuilder(string partitionName, StorageEntityDefinition entityDefinition)
        {
